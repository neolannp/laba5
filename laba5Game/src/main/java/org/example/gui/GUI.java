...
import org.example.DigitFilter;
import org.example.game.Game;
import org.example.player.Item;
...
public class GUI extends javax.swing.JFrame {
    ...
    public GUI() {
        ...
        playerIconLabel.setIcon(new ImageIcon("Fighter.png"));
    ...
    private void initComponents() {
        ...
        sureCloseFrame= new javax.swing.JFrame();
        sureClosePanel=new javax.swing.JPanel();
        sureCloseLabel=new javax.swing.JLabel();
        sureCloseButton=new javax.swing.JButton();

        fightPanel.setBackground(new java.awt.Color(250, 250, 250));


        attackButton.setBackground(new java.awt.Color(10, 0, 0));
        attackButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        attackButton.setForeground(new java.awt.Color(119, 2, 2));
        ...
        blockButton.setBackground(new java.awt.Color(10, 0, 0));
        blockButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        blockButton.setForeground(new java.awt.Color(119, 2, 2));
        ...
        playerHealthBar.setForeground(new java.awt.Color(0, 0, 0));
        playerHealthBar.setMaximum(80);
        playerHealthBar.setMinimum(-1);

        enemyHealthBar.setBackground(new java.awt.Color(204, 204, 204));
        enemyHealthBar.setForeground(new java.awt.Color(0, 0, 0));
        enemyHealthBar.setMinimum(-1);

        enemyHeroLabel.setBackground(new java.awt.Color(0, 0, 0));
        enemyHeroLabel.setFont(new java.awt.Font("Haettenschweiler", 2, 25)); // NOI18N

        enemyDamageLabel.setBackground(new java.awt.Color(255, 255, 255));
        enemyDamageLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 16)); // NOI18N
        enemyDamageLabel.setText("Damage");

        playerDamageLabel.setBackground(new java.awt.Color(255, 255, 255));
        playerDamageLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 16)); // NOI18N
        playerDamageLabel.setText("Damage");

        playerDamageValueLabel.setBackground(new java.awt.Color(255, 255, 255));
        playerDamageValueLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        playerDamageValueLabel.setForeground(new java.awt.Color(119, 2, 2));
        playerDamageValueLabel.setText("16");

        enemyDamageValueLabel.setBackground(new java.awt.Color(255, 255, 255));
        enemyDamageValueLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        enemyDamageValueLabel.setForeground(new java.awt.Color(119, 2, 2));
        enemyDamageValueLabel.setText("16");

        playerLevelLabel.setBackground(new java.awt.Color(255, 255, 255));
        playerLevelLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        playerLevelLabel.setText("0 level");

        fightLabel.setBackground(new java.awt.Color(255, 255, 255));
        fightLabel.setFont(new java.awt.Font("Haettenschweiler", 3, 36)); // NOI18N
        fightLabel.setForeground(new java.awt.Color(119, 2, 2));
        ...
        playerHealthLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        enemyHealthLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        experinceTitleLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        pointsTitleLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        experienceValueLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        pointsValueLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        enemyLevelLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        enemyLevelLabel.setText("1 level");

        turnLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        turnLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        enemyActionLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        enemyActionLabel.setForeground(new java.awt.Color(119, 2, 2));
        enemyActionLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        playerHeroLabel.setFont(new java.awt.Font("Haettenschweiler", 2, 25)); // NOI18N
        playerHeroLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        playerHeroLabel.setText("Fighter");

        stunLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        stunLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        itemsButton.setBackground(new java.awt.Color(0, 0, 0));
        itemsButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        itemsButton.setForeground(new java.awt.Color(119, 2, 2));
        ...
        playerActionLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        playerActionLabel.setForeground(new java.awt.Color(119, 2, 2));
        playerActionLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);

        debuffButton.setBackground(new java.awt.Color(10, 0, 0));
        debuffButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        debuffButton.setForeground(new java.awt.Color(119, 2, 2));
        ...
        endFightPanel.setBackground(new java.awt.Color(204, 204, 204));

        endRoundLabel.setBackground(new java.awt.Color(204, 204, 204));
        endRoundLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 40)); // NOI18N
        endRoundLabel.setForeground(new java.awt.Color(119, 2, 2));
        ...
        nextRoundButton.setFont(new java.awt.Font("Haettenschweiler", 0, 24)); // NOI18N
        ...
        victoryLabel.setFont(new java.awt.Font("Haettenschweiler", 3, 24)); // NOI18N
        victoryLabel.setForeground(new java.awt.Color(119, 2, 2));
        victoryLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        victoryLabel.setText("YOU WIN");

        enterNameField.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        ...
        enterNameLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        enterNameLabel.setForeground(new java.awt.Color(102, 102, 102));
        enterNameLabel.setText("write your name");

        enterNameLabelBottom.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        enterNameLabelBottom.setForeground(new java.awt.Color(102, 102, 102));
        enterNameLabelBottom.setText("for record table");

        endGameButton.setBackground(new java.awt.Color(204, 204, 204));
        endGameButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        endGameButton.setForeground(new java.awt.Color(51, 51, 51));
        endGameButton.setText("Finish the game");
        ...
        recordsTableLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 26)); // NOI18N
        recordsTableLabel.setForeground(new java.awt.Color(126, 8, 8));
        recordsTableLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        recordsTableLabel.setText("record table");
        ...
        closeRecordsTableButton.setFont(new java.awt.Font("Haettenschweiler", 0, 26)); // NOI18N
        closeRecordsTableButton.setForeground(new java.awt.Color(126, 8, 8));
        closeRecordsTableButton.setText("close");
        ...
        endGameWithoutLadderTitlleLabel.setFont(new java.awt.Font("Haettenschweiler", 3, 25)); // NOI18N
        endGameWithoutLadderTitlleLabel.setForeground(new java.awt.Color(119, 2, 2));
        endGameWithoutLadderTitlleLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        endGameWithoutLadderTitlleLabel.setText("YOU WIN");

        notInLadderLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        notInLadderLabel.setForeground(new java.awt.Color(102, 102, 102));
        notInLadderLabel.setText("Sorry, you aren't in the top 10");

        endGameWithoutLadderButton.setBackground(new java.awt.Color(204, 204, 204));
        endGameWithoutLadderButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        endGameWithoutLadderButton.setForeground(new java.awt.Color(51, 51, 51));
        endGameWithoutLadderButton.setText("Finish game");
        ...
        itemsBagPanel.setBackground(new java.awt.Color(204, 204, 204));

        itemsBagLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        itemsBagLabel.setForeground(new java.awt.Color(119, 2, 2));
        itemsBagLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        itemsBagLabel.setText("Bag of items");

        firstItemButton.setBackground(new java.awt.Color(204, 204, 204));
        firstItemButton.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        secondItemButton.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        thirdItemButton.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        thirdItemButton.setText("Cross of rebirth, 0 pcs");

        useItemButton.setBackground(new java.awt.Color(204, 204, 204));
        useItemButton.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        useItemButton.setForeground(new java.awt.Color(119,2,2));
        ...
        cantUseItemPanel.setBackground(new java.awt.Color(204, 204, 204));

        cantUseItemLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        cantUseItemLabel.setForeground(new java.awt.Color(119, 2, 2));
        cantUseItemLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        cantUseItemLabel.setText("You can't use ");

        unavailableItemLabel.setFont(new java.awt.Font("Haettenschweiler", 1, 25)); // NOI18N
        unavailableItemLabel.setForeground(new java.awt.Color(119, 2, 2));
        unavailableItemLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        unavailableItemLabel.setText("this item");

        closeCantUseItemButton.setBackground(new java.awt.Color(204, 204, 204));
        closeCantUseItemButton.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        closeCantUseItemButton.setForeground(new java.awt.Color(119, 2, 2));
        ...
        setLocationsLabel.setText("How many locations do you want to go through?");
        setLocationsLabel.setBackground(new java.awt.Color(204, 204, 204));
        setLocationsLabel.setFont(new java.awt.Font("Haettenschweiler", 0, 20)); // NOI18N
        setLocationsLabel.setForeground(new java.awt.Color(119, 2, 2));
        PlainDocument doc = (PlainDocument) setLocationsField.getDocument();
        doc.setDocumentFilter(new DigitFilter());

        setLocationsField.setText("5");
        ...
        startWithLocationsButton.setText("Start");
        ...
        levelUpLabel.setFont(new java.awt.Font("Haettenschweiler", 2, 20)); // NOI18N
        levelUpLabel.setForeground(new java.awt.Color(119, 2, 2));
        levelUpLabel.setText("What do you want to improve?");
        ...
        mkLabel.setFont(new java.awt.Font("Haettenschweiler", 2, 36)); // NOI18N
        mkLabel.setForeground(new java.awt.Color(126, 8, 8));
        mkLabel.setVerticalAlignment(SwingConstants.CENTER);
        mkLabel.setText("Mortal Kombat");

        startButton.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        ...
        seeResultsButton.setFont(new java.awt.Font("Haettenschweiler", 0, 25)); // NOI18N
        seeResultsButton.setText("Show results table");
    ...
    private void nextRoundButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextRoundButtonActionPerformed
        locationLabel.setText("Current location: " + game.fight.location.getCurrentLocation() + "/" + locationsNumber);
    ...
    private void startWithLocationsButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_startWithLocationsButtonActionPerformed
        ...
        game.fight.location.newGameLocation();
            if (locationsNumber > 0) {
                ...
                JOptionPane.showMessageDialog(setLocationsFrame, "please, select location greater than zero");
            }
